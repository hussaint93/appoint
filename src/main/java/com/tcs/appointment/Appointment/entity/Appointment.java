...
public class Appointment {
	...
	public String toString() {
		return "Appointment [appointment_id=" + appointment_id + ", user_name=" + user_name + ", user_mobno="
				+ user_mobno + ", user_email=" + user_email + ", trainerpreference=" + trainerpreference
				+ ", noofweeks=" + noofweeks + ", pacakageselected=" + pacakageselected + ", physiorequired="
				+ physiorequired + ", u_id=" + u_id + "]";
	}
